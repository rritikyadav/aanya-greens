            ...
            <div className="outer-white-box">
                <div className="white-box">
                    <div className="property-info">
                        ...
                        <p>
                            Aanya Greens – A soulful retreat beneath the Aravalli Hills,
                    ...
                    <div className="property-amenities">
                        ...
                        <div className="amenities-box">
                            <Amenities
                                image={"./assets/svgs/check-in-out.svg"}
                                text={"Private check-in/out"}
                            />
                            <Amenities image={"./assets/svgs/lounge.svg"} text={"Lounge"} />
                            <Amenities
                                image={"./assets/svgs/fireplace.svg"}
                                text={"Fireplace"}
                            />
                            <Amenities image={"./assets/svgs/garden.svg"} text={"Garden"} />
                            <Amenities image={"./assets/svgs/bar.svg"} text={"Bar-crawls"} />
                            <Amenities
                                image={"./assets/svgs/open-airpool.svg"}
                                text={"open-Air Bath"}
                            />
                            <Amenities
                                image={"./assets/svgs/opensitting.svg"}
                                text={"open-Air Sitting"}
                            />
                            <Amenities
                                image={"./assets/svgs/pet.svg"}
                                text={"Pet-Friendly Environment"}
                            />
                            <Amenities
                                image={"./assets/svgs/parking.svg"}
                                text={"Guest Parking"}
                            />
                            <Amenities
                                image={"./assets/svgs/wifi.svg"}
                                text={"Free Internet"}
                            />
                            <Amenities
                            ...
                            />
                            <Amenities
                                image={"./assets/svgs/spray.svg"}
                                text={"Disinfected Areas"}
                            />
                        </div>
                    </div>
                    <div className="aboutus-separationline"></div>
