    ...
    <>
      ...
      <div className="eventbox eventbox3">
        <div className="eventboximg">
          ...
          <img style={{ objectFit: "fill" }} src="./assets/birthday2.jpg" alt="" />
        </div>
        <div className="eventboxinfo">
      ...
      <div className="eventbox eventbox4">
        <div className="eventboxinfo">
          <h1>DJ Nights</h1>
          <p>
            &gt;&nbsp; Dance the night away under the stars with electrifying beats and a vibrant atmosphere.<br /><br />
            &gt;&nbsp; Our DJ nights feature top music, dazzling lights, and a lively crowd – the perfect mix for unforgettable memories.<br /><br />
            &gt;&nbsp; Whether you're celebrating a special occasion or just living in the moment, every night is a party at our resort.
          </p>
        </div>
        <div className="eventboximg">
          <img src="./assets/djnight2.jpg" alt="" />
          <img src="./assets/djnight1.jpg" alt="" />
        </div>
      </div>
